    ...
    createElementVNode("div", {
      ...
      createElementVNode("div", {
        ...
        createElementVNode("scroll-view", { scrollY: "true" }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($data.msgContent, (item) => {
              ...
              createElementVNode("view", {
                ...
                createElementVNode("div", {
                  ...
                  createElementVNode("div", { class: "info-date" }, [
                    createElementVNode("u-text", null, toDisplayString(item.Date), 1)
                  ]),
                  ...
                  createElementVNode("div", { class: "info-content" }, [
                    createElementVNode("u-text", null, toDisplayString(item.Message), 1)
                  ])
                ], 4)
              ], 4)
            ], 4);

<template>
  <template v-if="!menu.hideMenu"> 
    ...
    <div v-else-if="showMenuType === 1">
      <a v-if="menu.children[0].display=='EXTERNAL'" :href="menu.children[0].url" target="_blank">
    ...
    <div v-else>
      <a v-if="menu.display=='EXTERNAL'" :href="menu.url"  target="_blank">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    // todo: 优化if结构
    const showMenuType = computed(() => { // 0: 无子菜单， 1：有1个子菜单， 2：显示上下级子菜单 -1外部链接

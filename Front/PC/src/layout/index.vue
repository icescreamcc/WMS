<template>
  <el-container style="height: 100vh">
    ...
    <el-container>
      ...
      <!-- <div style="width: 100%;height: 22px;line-height: 21px;font-size: 12px;color: #b4b3b3;">V3.0.10 ©2023-2026 Continental Changsha</div> -->
    </el-container>
  </el-container>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const systemVersion = computed(() => {
      return systemInfo.value.find((item: any) => item.argsKey === "SystemVersion")?.argsValue;
    });

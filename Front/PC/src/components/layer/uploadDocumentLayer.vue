    ...
    <div class="layout-container">
      ...
      <div class="layout-container-table">
        <Table ref="table" v-model:page="page" v-loading="loading" :showSelection="true" :data="tableData"
          ...
          <el-table-column prop="fileName" label="文件名称" align="center" sortable="custom" min-width="160"
            :show-overflow-tooltip="true" />
          <el-table-column prop="url" label="文件地址" align="center" sortable="custom" min-width="300"
            :show-overflow-tooltip="true" >
...
import { getBaseFiles } from '@/api/purchase/sendingorder';
...
const props=defineProps({
  ...
  const query = reactive({
    input: "",
    fileInfoType:"SendingOrderAttachment",
  });

        ...
        <div class="content-main">
            ...
            <el-form  :model="dataForm"  ref="dataFormRef"  label-width="auto" label-position="left" style="padding:0 15px">
              <div>
                ...
                <el-row class="input-item">
                    <el-col :span="8">
                        <div class="input-title">缓存库位码</div> 
                    </el-col>
                    <el-col :span="14"> 
                        <input type="text" v-model="dataForm.scanBinNo" @keyup.enter="onScanBinCode($event)" @focus="commonHelper.stopKeyborad($event)" id="input-binNo" placeholder="请扫描缓存仓库位码" class="input-cls">  
                    </el-col>
                    <el-col :span="2"> 
                       <div class="input-icon">
                        <img :src="scanImg" alt="" height="20"> 
                ...
                <el-row class="input-item">
                    <el-col :span="8">
                        <div class="input-title">所在库位</div>
                    </el-col>
                    <el-col :span="16">
                ...
                <el-row class="input-item">
                    ...
                    <el-col :span="16">
                        <input type="text"  v-model="dataForm.total" readonly class="input-cls"> 
                    </el-col>
                </el-row>  
                <el-row class="input-item">
                        <el-col :span="8">
            ...
            <div class="content-desc">
               <div style="padding-top: 4%;">
                ...
                <div>
                    <p style="margin-top: -5px;">扫描小车唯一码→查询装车信息→扫描库位码→确认下架</p>
                    <p style="margin-top: -5px;">当扫描库位码和小车唯一码不一致时不允许下架</p> 
                </div>
               </div>
            </div> 
        </div> 
        <div class="content-btn">
                <div v-if="permission.isPermisstion('PUTOUTSUBMIT')">
                    <el-button  type="success" round  @click="onSubmit" style="width:82%;" :loading="submitLoading">确认下架</el-button> 
                </div>
...
import {getProductionOrderInfo,checkPutout,submitPutout}  from '@/api/mobile-pda/putout'
...
const onScanBinCode=(e:any)=>{ 
 e.preventDefault(); 
 if(e.keyCode==13&&dataForm.value.carSoleCode){ 
    checkPutout(dataForm.value.carSoleCode,dataForm.value.scanBinNo).then(res=>{
        if(res.data){
            msg.deftAuto('校验成功');
        }
...
const onSubmit=()=>{ 
    ...
    submitPutout(dataForm.value).then(res=>{ 
        onClearForm();

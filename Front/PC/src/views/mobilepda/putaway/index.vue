        ...
        <div class="content-main">
            ...
            <el-form  :model="dataForm"  ref="dataFormRef"  label-width="auto" label-position="left" style="padding:0 15px">
              <div>
                ...
                <el-row class="input-item">
                    <el-col :span="8">
                        <div class="input-title">推荐缓存库位</div>
                    </el-col>
                    <el-col :span="16">
            ...
            <div class="content-desc">
               <div style="padding-top: 4%;">
                ...
                <div>
                    <p style="margin-top: -5px;">扫描小车唯一码→查询装车信息→扫描推荐的库位码→确认上架</p>
...
import {getProductionOrderInfo,checkPutaway,submitPutaway} from '@/api/mobile-pda/putaway'
...
const onScanBinCode=(e:any)=>{ 
 ...
 if(e.keyCode==13&&dataForm.value.carSoleCode&&dataForm.value.scanBinNo){ 
    checkPutaway(dataForm.value.carSoleCode,dataForm.value.scanBinNo).then(res=>{
        if(res.data){
            msg.deftAuto('校验成功');
        }

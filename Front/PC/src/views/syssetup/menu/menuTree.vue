     ...
     <el-row style="width:100%">
       <el-col :span="12" style="text-align:left">
        ...
        <el-col :span="12"  style="text-align:right">
          <el-button type="primary" title="新增菜单" icon="el-icon-circle-plus-outline"  @click="handleAdd" ></el-button> 
...
import{getMenusData,addMenu} from '@/api/system/menus'

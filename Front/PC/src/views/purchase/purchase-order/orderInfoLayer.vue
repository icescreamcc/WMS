<template>
    <Layer :layer="layer" @confirm="submit" >
       <el-form :model="ruleForm" :rules="rules" ref="formRef" label-width="auto" label-position="left" style="padding:0 15px">
        <el-tabs v-model="tabSelected" style="box-shadow:none;-webkit-box-shadow:none;min-height:380px">
            ...
            <el-row>
                <el-col :span="11">
                  <el-form-item label="采购方式" prop="purchaseTypeId">
                    <el-select v-model="ruleForm.purchaseTypeId" class="m-2" :disabled="!props.layer.showButton"  style="width:100%" placeholder="请选择采购方式 *必填">
            ...
            <el-row>
                <el-col :span="11">
                  <el-form-item label="是否申请料号" prop="isApplyMaterialNumber">
                   <span>{{ ruleForm.isApplyMaterialNumber?'是':'否' }}</span> 
                  </el-form-item> 
              </el-col>
              <el-col :span="11" :offset="2"> 
                <el-form-item label="是否采买" prop="isPurchaseBuy">
                  <span>{{ ruleForm.isPurchaseBuy?'是':'否' }}</span>  
                  </el-form-item> 
              </el-col>  
            </el-row>
            <el-row>
            ...
            <el-row>
              <el-col :span="11">
                <el-form-item label="本次采买数量" prop="quantity">
                  <el-input-number v-model="ruleForm.quantity" :disabled="!props.layer.showButton" style="width:100%" :min="0" controls-position="right" placeholder="本次采买数量" type="number" />  
                  </el-form-item>  
              </el-col>
              <el-col :span="11" :offset="2"> 
          ...
          <el-tab-pane label="下单CEOS信息" name="ceos" v-if="ruleForm.isPurchaseBuy"> 
              <el-row>
                  <el-col :span="11">
                    <el-form-item label="采购科目" prop="accountNumber"> 
                    <el-select style="width: 100%;" v-model="ruleForm.accountNumber" :disabled="!props.layer.showButton" placeholder="选择采购科目" >
                ...
                <el-col :span="11" :offset="2"> 
                  <el-form-item label="PM类型" prop="pmType"> 
                    <el-select style="width: 100%;" v-model="ruleForm.pmType" :disabled="!props.layer.showButton" placeholder="选择PM类型" >
              ...
              <el-row>
                  <el-col :span="11">
                    ...
                    <el-select style="width: 100%;" v-model="ruleForm.cpmg" :disabled="!props.layer.showButton" placeholder="选择CPMG" >
            ...
            <el-row> 
              <el-col :span="11"> 
                <el-form-item label="产线名称" prop="line">
                  <el-select v-model="ruleForm.line" class="m-2" :disabled="!props.layer.showButton" @change="onSelectLine" style="width:100%" placeholder="请选择产线名称 *必填">
              ...
              <el-col :span="11" :offset="2"> 
                <el-form-item label="产线编码" prop="lineNo">
                  <el-select v-model="ruleForm.lineNo" class="m-2" :disabled="!props.layer.showButton" @change="onSelectLineNo" style="width:100%" placeholder="请选择产线编码 *必填">
          ...
          <el-tab-pane label="申请SAP号信息" name="apply" v-if="ruleForm.isApplyMaterialNumber">
            <el-row>
                  <el-col :span="11">
                    ...
                    <el-select style="width: 100%;" v-model="ruleForm.classesNumber" :disabled="!props.layer.showButton" placeholder="选择类别" @change="onSelectClassesNumber">
                ...
                <el-col :span="11" :offset="2"> 
                  <el-form-item label="类别描述" prop="classesNumberDesc">
                    <el-input v-model="ruleForm.classesNumberDesc" :disabled="!props.layer.showButton" placeholder="类别描述"/>
                    </el-form-item>
                </el-col>  
              </el-row> 
            <el-row>
                <el-col :span="11"> 
                  <el-form-item label="物料分类" prop="goodsClassifyId">
                    <el-select v-model="ruleForm.goodsClassifyId" class="m-2" :disabled="!props.layer.showButton"  style="width:100%" placeholder="请选择物料类型 *必填" @change="onSelectGoodsClassifyName">
              ...
              <el-col :span="11" :offset="2"> 
                <el-form-item label="MNA编码" prop="mnano">
            ...
            <el-row>
              ...
              <el-col :span="11" :offset="2"> 
                <el-form-item label="PO号" prop="poNumber">
                  <el-input v-model="ruleForm.poNumber" :disabled="!props.layer.showButton" style="width:100%"  placeholder="PO号"/>  
                  </el-form-item> 
              </el-col>  
            </el-row> 
            <el-row>
              ...
              <el-col :span="11" :offset="2"> 
                <el-form-item label="PR号" prop="prNumber">
                  <el-input v-model="ruleForm.prNumber" :disabled="!props.layer.showButton" style="width:100%"  placeholder="PR号"/>  
                  </el-form-item> 
              </el-col>  
            </el-row>
          ...
          <el-tab-pane label="实物到货信息" name="arrived">
            ...
            <el-row>
                  <el-col :span="11">
                    <el-form-item label="物料图片上传">
                      <ImgUpload :uploadParams="pictureUploadParams"  @handleImgChanged="imgChanged"/>
                    </el-form-item> 
                </el-col> 
              </el-row> 
          </el-tab-pane>
          <el-tab-pane label="WK收货信息" name="receve">
            <el-row>
                <el-col :span="11">
                <el-form-item label="收货状态" prop="receivingStatus"> 
                    <el-select v-model="ruleForm.receivingStatus" class="m-2" :disabled="!props.layer.showButton"  style="width:100%" placeholder="选择到货状态">     
                            <el-option v-for="item in orderReceiveStatusData" :value="item.key" :label="item.value"></el-option> 
                    </el-select> 
                  </el-form-item>
              </el-col>
              <el-col :span="11" :offset="2"> 
                <el-form-item label="收货时间" prop="receivingDate">
                  <el-date-picker v-model="ruleForm.receivingDate" :disabled="!props.layer.showButton" style="width:100%" type="datetime" placeholder="选择收货时间"> </el-date-picker>   
                  </el-form-item> 
              </el-col>  
            </el-row>
            <el-row>
              <el-col :span="11">
                    <el-form-item label="GR号" prop="grNo">
                    <el-input v-model="ruleForm.grNo"  :disabled="!props.layer.showButton" style="width:100%" :min="0"  placeholder="请填写GR号"/> 
                    </el-form-item> 
                </el-col> 
                  <el-col :span="11" :offset="2" v-if="ruleForm.receivingStatus=='Abnormal'">
                    <el-form-item label="收货异常原因" prop="receivingAbnormalReason">
                    <el-input v-model="ruleForm.receivingAbnormalReason"  :disabled="!props.layer.showButton" style="width:100%" :min="0"  placeholder="收货异常原因"/> 
                    </el-form-item> 
                </el-col> 
              </el-row>  
          </el-tab-pane> 
          <el-tab-pane label="审批流程" name="approvalHis">
  ...
  const ruleForm = ref({
      ...
      arrivalDate:props.layer.data?.arrivalDate?commonHelper.formatToDateTime(props.layer.data?.arrivalDate):'',
      quantityArrival:props.layer.data?.quantityArrival,
      receivingStatus:props.layer.data?.receivingStatus,
      receivingDate:props.layer.data?.receivingDate?commonHelper.formatToDateTime(props.layer.data?.receivingDate):'',
  ...
  const rules = {  
      ...
      goodsClassifyId:[{ required: true, message: '请选择物料类型', trigger: 'change' }], 
      externalOrderNo:[{ required: true, message: '请填写SAP订单号', trigger: 'blur' },{ max: 50, message: '字符超出限制长度', trigger: 'blur'}],
      goodsNameZH:[{ required: true, message: '请填写物料中文名称', trigger: 'blur' },{ max: 30, message: '字符超出限制长度', trigger: 'blur'}], 
      goodsNameEN:[{ max: 30, message: '字符超出限制长度', trigger: 'blur'}], 
      flowStatus:[{ required: true, message: '请选择流程状态', trigger: 'change' }], 
      mnano:[{ max: 50, message: '字符超出限制长度', trigger: 'blur'}],
      goodsModel:[{ required: true, message: '请物料型号', trigger: 'blur' },{ max: 30, message: '字符超出限制长度', trigger: 'blur'}], 
      npmBuyer:[{ required: true, message: '请填写NPM采购', trigger: 'blur' }], 
      npmBuyerEMail:[{ type: 'email', message: '请输入正确的邮箱', trigger: 'blur'}], 
      ...
      manufactor:[{ max: 100, message: '字符超出限制长度', trigger: 'blur'}],
      ...
      applyReason:[{ max: 200, message: '字符超出限制长度', trigger: 'blur'}],

      consigneeFullName:[{ required: true, message: '请选择收货人', trigger: 'change' }],
      line:[{ required: true, message: '请选择适用产线', trigger: 'change' }], 
      classesNumber:[{ required: true, message: '请选择类别编号', trigger: 'change' }],
      classesNumberDesc:[{ required: true, message: '请填写类别描述或关键字', trigger: 'blur' }],
      safetyInventory:[{ required: true, message: '请填写安全库存', trigger: 'blur' }],
      minLotSize:[{ required: true, message: '请填写最小采购量', trigger: 'blur' },{ validator: validateZero, trigger: 'blur' }],
      returnCycle:[{ required: true, message: '请填写回货周期', trigger: 'blur' },{ validator: validateZero, trigger: 'blur' }],
      description:[{ max: 100, message: '字符超出限制长度', trigger: 'blur'}],  
  }  
  ...
  onMounted(()=>{ 
    ...
    for(let i=0;i<ruleForm.value.approvalHis.length;i++){
          if(i==0){
            ruleForm.value.approvalHis[i].color="#67c23a";
            ruleForm.value.approvalHis[i].icon="MoreFilled"
          }
          else{
              if(ruleForm.value.approvalHis[i].approvalStatus=='Reject'){
                ruleForm.value.approvalHis[i].color="#f56c6c";
              }
              else if(ruleForm.value.approvalHis[i].approvalStatus=='Approvaling'){
                ruleForm.value.approvalHis[i].color="#e6a23c";
              } 
              else  if(ruleForm.value.approvalHis[i].approvalStatus=='Approve'){
                ruleForm.value.approvalHis[i].color="#409eff";
              }
              else{
                ruleForm.value.approvalHis[i].color='#c1b9b9';
              }
          }
      }
  }); 

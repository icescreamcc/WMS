<template>
  <Layer :layer="layer" @confirm="submit">
    <el-form label-width="auto" label-position="left" :model="ruleForm" :rules="rules" ref="formRef"
      ...
      <el-tabs v-model="tabSelected" style="box-shadow:none;-webkit-box-shadow:none;min-height:380px">
        <el-tab-pane label="基本信息" name="base">
          <el-row>
            <el-col :span="11">
              <el-form-item label="原材料ID" style="margin-left:20px">
                <el-input v-model="ruleForm.goodsId" readonly placeholder="系统生成 无需填写"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="11">
              <el-form-item label="原材料分类" style="margin-left:20px">
          ...
          <el-row>
            <el-col :span="11">
              <el-form-item label="SAP编码" prop="goodsNo" style="margin-left:20px">
                <el-input v-model="ruleForm.goodsNo" placeholder="请输入原材料编码" autofocus></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="11">
              <el-form-item label="原材料名称" prop="goodsName" style="margin-left:20px">
                <el-input v-model="ruleForm.goodsName" placeholder="请输入原材料名称  *必填"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="11">
              <el-form-item label="原材料属性" prop="goodsProperty" style="margin-left:20px">
                <el-input v-model="ruleForm.goodsProperty" placeholder="输入原材料属性、参数等信息"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="11">
              <el-form-item label="原材料类型" style="margin-left:20px">
                <el-select v-model="ruleForm.goodsTypeId" class="m-2" placeholder="选择原材料类型" style="width:100%">
                  <el-option v-for="item in rawMaterialTypeData" :key="item.optionId" :label="item.optionName"
                    :value="item.optionId">
                  </el-option>
                </el-select>
              </el-form-item>
          ...
          <el-row>
            <el-col :span="11">
              <el-form-item label="供应商" prop="supplier" style="margin-left:20px">
                <el-select style="width: 100%;" v-model="ruleForm.supplier" filterable remote reserve-keyword
                  placeholder="输入供应商关键字查询" :remote-method="getSupplierData" @change="onSelectSupplier"
                  :loading="querySupplierLoading">
                  <el-option v-for="item in supplierData" :key="item.supplierId" :label="item.supplierName"
            ...
            <el-col :span="11">
              <el-form-item label="标准包装单位" prop="packageUnitName" style="margin-left:20px">
                <el-select v-model="ruleForm.packageUnitName" class="m-2" placeholder="请选择标准包装单位 *必填" style="width:100%"
                  @change="onSelectPackageUnit">
                  <el-option v-for="item in unitsData" :key="item.key" :label="item.value" :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="11">
              <el-form-item label="最小包装单位" prop="minPackageUnitName" style="margin-left:20px">
                <el-select v-model="ruleForm.minPackageUnitName" class="m-2" placeholder="请选择最小包装单位 *必填"
                  style="width:100%">
                  <el-option v-for="item in unitsData" :key="item.key" :label="item.value" :value="item.value">
                  </el-option>
                </el-select>
            ...
            <el-col :span="11">
              <el-form-item label="最大包装单位" prop="maxPackageUnitName" style="margin-left:20px">
                <el-select v-model="ruleForm.maxPackageUnitName" class="m-2" placeholder="请选择最大包装单位 *必填"
                  style="width:100%">
                  <el-option v-for="item in unitsData" :key="item.key" :label="item.value" :value="item.value">
                  </el-option>
                </el-select>
          ...
          <el-row>
            <el-col :span="11">
              <el-form-item label="库存单位" prop="safetyInventoryUnitName" style="margin-left:20px">
                <el-select v-model="ruleForm.safetyInventoryUnitName" class="m-2" placeholder="请选择库存单位 *必填"
                  style="width:100%">
                  <el-option
                    ...
                    :key="item.key" :label="item.value" :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="2">
              <p style="margin-top:6px;color:#888">
                {{ ruleForm.safetyInventoryUnitName ? ruleForm.safetyInventoryUnitName : '--' }}</p>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="11">
        ...
        <el-tab-pane label="外观尺寸" name="facade">
            ...
            <el-col :span="11">
              <el-form-item label="尺寸单位" style="margin-left:20px">
                <el-select v-model="ruleForm.sizeUnitName" class="m-2" placeholder="选择尺寸单位" style="width:100%">
                  <el-option v-for="item in unitsData.filter(x => x.type == 'Size')" :key="item.key" :label="item.value"
                    :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
            ...
            <el-col :span="11">
              <el-form-item label="重量单位" prop="color" style="margin-left:20px">
                <el-select v-model="ruleForm.weightUnitName" class="m-2" placeholder="选择重量单位" style="width:100%">
                  <el-option v-for="item in unitsData.filter(x => x.type == 'Weight')" :key="item.key" :label="item.value"
                    :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
          ...
          <el-row>
            <el-col :span="11">
              <el-form-item label="储存规格" style="margin-left:20px">
                <el-select v-model="ruleForm.goodsSpecificationId" class="m-2" placeholder="选择原材料存放料箱的规格"
                  style="width:100%">
                  <el-option v-for="item in workbinSpecData" :key="item.key" :label="item.value" :value="item.key">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="9">
              <el-form-item label="最大堆放量" prop="color" style="margin-left:20px">
                <el-input v-model="ruleForm.maxStock" type="number" title="相对该规格料箱的最大堆放数量"
                  placeholder="相对该规格料箱的最大堆放数量"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="2">
              <p style="margin-top:6px;color:#888">
          ...
          <el-row>
            <el-col :span="24" style="margin-bottom:40px">
              <el-form-item label="原材料图片" style="height:50px;margin-left:20px">
          ...
          <el-row>
            ...
            <el-col :span="11">
              <el-row>
                ...
                <el-col :span="7">
                  <el-form-item label-width="10px">
                    <el-select v-model="ruleForm.refPurchPriceUnitName" class="m-2" placeholder="选择单位"
                      style="width:100%">
                      <el-option
                        v-for="item in unitsData.filter(x => x.value == ruleForm.packageUnitName || x.value == ruleForm.minPackageUnitName || x.value == ruleForm.maxPackageUnitName)"
                        :key="item.key" :label="item.value" :value="item.value">
            ...
            <el-col :span="11">
              <el-form-item label="价格单位" style="margin-left:20px">
                <el-select v-model="ruleForm.priceUnitName" class="m-2" placeholder="选择价格单位" style="width:100%">
                  <el-option v-for="item in unitsData.filter(x => x.type == 'Currency')" :key="item.key" :label="item.value"
                    :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
          ...
          <el-row>
            <el-col :span="11">
              <el-row>
                ...
                <el-col :span="7">
                  <el-form-item label-width="10px">
                    <el-select v-model="ruleForm.purchaseMinimumUnitName" class="m-2" placeholder="选择单位"
                      style="width:100%">
                      <el-option
                        v-for="item in unitsData.filter(x => x.value == ruleForm.packageUnitName || x.value == ruleForm.minPackageUnitName || x.value == ruleForm.maxPackageUnitName)"
                        :key="item.key" :label="item.value" :value="item.value">
        ...
        <el-tab-pane label="自定义">
          <el-row>
            <el-col :span="11" v-if="getSpareFields('GoodsField1')">
              <DynamicFields :fieldsInfo="getSpareFields('GoodsField1')" :fieldsData="ruleForm.goodsField1"
                v-model="ruleForm.goodsField1" />
            </el-col>
            <el-col :span="11" v-if="getSpareFields('GoodsField2')">
              <DynamicFields :fieldsInfo="getSpareFields('GoodsField2')" :fieldsData="ruleForm.goodsField2"
                v-model="ruleForm.goodsField2" />
            </el-col>
            <el-col :span="11" v-if="getSpareFields('GoodsField3')">
              <DynamicFields :fieldsInfo="getSpareFields('GoodsField3')" :fieldsData="ruleForm.goodsField3"
                v-model="ruleForm.goodsField3" />
            </el-col>
            <el-col :span="11" v-if="getSpareFields('GoodsField4')">
              <DynamicFields :fieldsInfo="getSpareFields('GoodsField4')" :fieldsData="ruleForm.goodsField4"
                v-model="ruleForm.goodsField4" />
            </el-col>
            <el-col :span="11" v-if="getSpareFields('GoodsField5')">
              <DynamicFields :fieldsInfo="getSpareFields('GoodsField5')" :fieldsData="ruleForm.goodsField5"
                v-model="ruleForm.goodsField5" />
            </el-col>
          </el-row>
        </el-tab-pane>
      </el-tabs>
...
const rawMaterialTypeData = ref(new Array<any>());
...
const sapNoValid = (rule: any, value: any, callback: any) => {
  if (value && !ruleForm.value.goodsNo?.trim()) {
    callback(new Error("请输入原材料在SAP中的编码"))
  }
  else {
    callback()
  }
...
const rules: any = {
  ...
  goodsName: [{ required: true, message: '请输入原材料名称', trigger: 'blur' }, { max: 50, message: '字符超出限制长度', trigger: 'blur' }],
...
const getOptionData = () => {
  getOptions().then(res => {
    rawMaterialTypeData.value = res.data.rawMaterialTypeOptions?.argsOptions;

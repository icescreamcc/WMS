              ...
              <el-col :span="8">
                <div class="body-order">
                  ...
                  <el-col :span="6" class="item-img">
                      <el-image style="width: 70px;height: 70px; border-radius: 4px;" hide-on-click-modal :src="item.goodsPicture"  :zoom-rate="1.2" :preview-src-list="[item.goodsPicture]" :initial-index="0"  fit="cover"/> 
                    </el-col>

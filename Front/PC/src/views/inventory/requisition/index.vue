    ...
    <div class="content" ref="pageContent"> 
       <div class="content-header">
           <el-row >
               ...
               <el-col :span="8"  class="header-title"><h3>{{titleDesc}}领用</h3></el-col>
       ...
       <div class="content-body" > 
                ...
                <el-col :span="6" v-for="item in goodsData" :key="item.goodsId">
                   <div class="content-item" >
                    ...
                    <div class="item-desc">
                            ...
                            <div class="desc-info">存&nbsp;放&nbsp;库&nbsp;位：{{item.deftStockBinCell||item.deftStockBin}}</div>
                            <div class="desc-info">
           ...
           <div class="content-order" id="orderImgBtn"> 
            ...
            <!-- <img class="order-list" src="/public/icon-img/agv-business5.png" title="点击查看AGV任务" @click="onShowAgvList">  -->
            <img class="order-list" src="/public/icon-img/xiaoxi7.png" title="点击查看AGV任务" @click="onShowAgvList"> 
       ...
       <AGVListDrawer :layer="agvListOptions"  @dataSubmit="onSubmitRemove" v-if="agvListOptions.show" />  
       <!-- <AGVListDrawer :options="agvListOptions" v-if="agvListOptions.show" @submited=""/>  -->
   </div>
</template>
...
//import AGVListDrawer from "./agvListDrawer.vue";
import AGVListDrawer from "./agvListLayer.vue";
...
// const agvListOptions= ref({
//   show: false,
//   title: '', 
//   type:'', 
//   data:{}
// });
const agvListOptions: LayerInterface = reactive({
      show: false,
      title: "",
      showButton: false,
      btnLoading:false,
...
const getGoodsGroupData=()=>{
   return getGoodsGroup().then(res=>{
        ...
        titleDesc.value=goodsGroupData.value.find(f=>f.key==selectedGoodsGroup.value).value;
    })
}
...
const onShowAgvList=()=>{ 
      ...
      agvListOptions.title = "AGV任务";
      //agvListOptions.row = row; 
      agvListOptions.type='agv'
      agvListOptions.show = true;  
      agvListOptions.otherButton.show=false;

    // agvListOptions.value.show=true;
    // agvListOptions.value.type=selectedGoodsGroup.value;
}
const toHome=()=>{
    window.history.back();
}

<template>
       ...
       <el-form :model="ruleForm" :rules="formRules" ref="formRef" label-width="auto" label-position="left" style="padding:0 15px">
        ...
        <el-row>
            ...
            <el-form-item  prop="signingDate">
             ...
             <el-date-picker v-model="ruleForm.signingDate" :disabled="!props.layer.showButton" style="width:100%" type="date" value-format="YYYY-MM-DD"  placeholder="请选择日期"> </el-date-picker>
              </el-form-item>
          </el-col>
          <el-col :span="11" :offset="2"> 
            <el-form-item  prop="customerName">
               <template #label>
                 ...
                 <el-select v-model="ruleForm.customerName" :disabled="!props.layer.showButton" class="m-2" style="width:100%;margin-left:5px" placeholder="客户名称" >
        ...
        <el-row>
            <el-col :span="11">
              ...
              <el-select v-model="ruleForm.unit" :disabled="!props.layer.showButton" class="m-2" style="width:100%;margin-left:5px" placeholder="单位" >
        ...
        <el-row>
            <el-col :span="11">
              ...
              <el-select v-model="ruleForm.goodsName" :disabled="!props.layer.showButton" class="m-2" style="width:100%;margin-left:5px" placeholder="物品名称" >
        ...
        <el-row>
            ...
            <el-form-item  prop="deliveryDate">
               ...
               <el-date-picker v-model="ruleForm.deliveryDate" :disabled="!props.layer.showButton" style="width:100%" type="date" value-format="YYYY-MM-DD"  placeholder="请选择日期"> </el-date-picker>
              </el-form-item>
          </el-col>
          <el-col :span="11" :offset="2"> 
  ...
  const emit = defineEmits(['dataSubmit']); 
   ...
   const ruleForm = ref({
      ...
      goodsName:props.layer.row?.goodsName || 'S10000003',
  ...
  watch(() => props.layer.row, (newVal) => {
    if (newVal) {
      ruleForm.value = {
        ...
        goodsName: newVal.goodsName || 'S10000003',

...
{
    public class AuthorizeTokenFilter : Attribute, IAsyncAuthorizationFilter
    { 
        ...
        public AuthorizeTokenFilter( TokenHelper tokenHelper, UserMgr userMgr, SysArgsService sysArgsHelper, IConfiguration configuration)
        { 
            ...
            if (headers.ContainsKey("authorization"))
            {
                ...
                if (!string.IsNullOrEmpty(token))
                {
                    ...
                    if (DateTime.Now <= tokenModel.Expiration)
                    {
                        ...
                        _tokenHelper.SetTokenCache(tokenModel.UserId, newToken);
